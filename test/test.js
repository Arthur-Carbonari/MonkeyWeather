...
QUnit.test("checkIfClothesAreNeededAccordingToTemperature3", assert => {
    //mock object

    let mockProcessedWeatherData = [{ time: '2020-03-01 06:00:00', tempFellsLike: 40, weather: 'Sunny' }];


    assert.true(weatherApp.checkIfClothesAreNeededAccordingToTemperature(mockProcessedWeatherData, 30, 100));
    
})

QUnit.test("checkIfClothesAreNeededAccordingToTemperature4", assert => {
    //mock object
...
QUnit.test("clothesMessage3", assert => {
    //mock object
    ...
    let expectedResult = "You will need rainy weather clothes, winter clothes, cold weather clothes, chilly weather clothes, mild weather clothes, warm weather clothes, summer clothes, make sure u bring all the clothes you need. Have a nice trip."
